...
import net.staticstudios.data.mock.wrapper.booleanprimitive.BooleanWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.bytearrayprimitive.ByteArrayWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.doubleprimitive.DoubleWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.floatprimitive.FloatWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.integerprimitive.IntegerWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.longprimitive.LongWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.stringprimitive.StringWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.timestampprimitive.TimestampWrapperDataClassFactory;
...
import net.staticstudios.data.mock.wrapper.uuidprimitive.UUIDWrapperDataClassFactory;
...
public class CustomTypeTest extends DataTest {
    ...
    public void testCustomTypeWithStringPrimitive() throws SQLException {
        ...
        StringWrapperDataClass data = StringWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithIntegerPrimitive() throws SQLException {
        ...
        IntegerWrapperDataClass data = IntegerWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithLongPrimitive() throws SQLException {
        ...
        LongWrapperDataClass data = LongWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithFloatPrimitive() throws SQLException {
        ...
        FloatWrapperDataClass data = FloatWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithDoublePrimitive() throws SQLException {
        ...
        DoubleWrapperDataClass data = DoubleWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithBooleanPrimitive() throws SQLException {
        ...
        BooleanWrapperDataClass data = BooleanWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithUUIDPrimitive() throws SQLException {
        ...
        UUIDWrapperDataClass data = UUIDWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithTimestampPrimitive() throws SQLException {
        ...
        TimestampWrapperDataClass data = TimestampWrapperDataClassFactory.builder(dataManager)
                .id(1)
    ...
    public void testCustomTypeWithByteArrayPrimitive() throws SQLException {
        ...
        ByteArrayWrapperDataClass data = ByteArrayWrapperDataClassFactory.builder(dataManager)
                .id(1)
