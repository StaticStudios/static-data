...
/**
 * This annotation is applicable to PersistentValues and CachedValues.
 * Instead of propagating updates to the real database/redis instantly, only the latest update will be made every Nms.
